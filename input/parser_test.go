...
var parserTests = ParserTestCases{
	...
	ParserTestCase{
		fmt: "json",
		tests: []string{
			`{"version": "1.1", "host": "example.org", "short_message": "A short message that helps you identify what is going on", "timestamp": "1095379198.75", "level": 1, "_user_id": 9001, "_some_info": "foo", "_some_env_var": "bar"}`,
		},
		results: []map[string]interface{}{
			map[string]interface{}{
				"version":       "1.1",
